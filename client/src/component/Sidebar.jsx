      ...
      <div className="w-[20%] flex flex-col justify-between   bg-blue-400 h-screen rounded-r-3xl ">
        ...
        <div className="flex flex-col gap-10 pl-10 text-2xl font-semibold  ">
          ...
          <div className="flex flex-row items-center justify-start gap-8">
            ...
            >
              <path
                d="M26 27H18.5714V0H26V27ZM20.4286 24.9231H24.1429V2.07692H20.4286V24.9231ZM16.7143 27H9.28571V8.30769H16.7143V27ZM11.1429 24.9231H14.8571V10.3846H11.1429V24.9231ZM7.42857 27H0V14.5385H7.42857V27Z"
                fill="black"
              />
            </svg>
