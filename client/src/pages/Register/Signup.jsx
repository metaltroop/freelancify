...
const Signup = () => {
  ...
  let toggleTranslateCheck = btnState ? "200" : "100";
        ...
        <form onSubmit={login}>
          <div className={`Register${toggleFormCheck}`}>
            <div className="flex">
              <div
                id="logintext"
                className=" z-[10] flex LoginOverlay flex-col justify-center items-center w-[35%] h-[100vh] rounded-[0px_50px_50px_0px] transition-all duration-500 "
              >
        ...
        <form onSubmit={register}>
          <div className={`RegisterForm${toggleClassCheck}`}>
            <div className="w-[100%] flex h-screen fixed">
              ...
              <div
                id="registertext"
                className=" z-[10] flex flex-col justify-center items-center w-[35%] h-[100vh] rounded-[50px_0px_0px_50px]  duration-700"
              >
                <img src={Logo} alt="logo" width={200} className="mr-4" />
                <h1 className="text-gray-700 font-semibold font-sans text-5xl">
                  Welcome Guest
